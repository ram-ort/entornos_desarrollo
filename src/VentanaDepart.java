...
/**
 * Extraemos una constante local llamada NOEXISTEDEPART de la cadena: "DEPARTAMENTO NO EXISTE".
 */
private static final String NOEXISTEDEPART = "DEPARTAMENTO NO EXISTE.";

/**
 * Extraemos una variable local llamada existedepart de la cadena: "DEPARTAMENTO EXISTE.", y la convertimos en atributo de la clase
 */
private static String existedepart = "DEPARTAMENTO EXISTE.";


/**
 * Extraemos una variable local llamada depar_error de la cadena: "DEPARTAMENTO ERRÓNEO", y la convertimos en un atributo de la clase.
 */
private static String depar_error = "DEPARTAMENTO ERRÓNEO.";

JTextField num=new JTextField(10);
JTextField nombre=new JTextField(25);
JTextField loc=new JTextField(25);

private int dep, confirm;
...
/**
 * Extraemos los métodos de las instrucciones que van dentro de los distintos if(e.getSource()), que preguntan por balta, consu, borra y modif, y los llamamoa altadepart, consuldepart, borradepart y modifdepart
 */
	if (e.getSource() == balta) { //SE PULSA EL BOTÓN  alta
		altadepart();
	}		   
...
public void verporconsola() throws IOException {
  ...
  if (file.length() > 0) {
	...
	System.out.println(" ------------------------------------------");  
	  ...
	  System.out.println(" ---------FICHERO VACIIOOOO --------------------");
	  file.close();
  }      
} // fin verporconsola
